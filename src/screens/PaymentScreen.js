...
export default function PaymentScreen({ navigation }) {
  const history = [
    { id: '1', billNo: 'INV-2025-098', shop: 'Kandy City Store', location: 'Kandy', amount: '4,500', date: '2026-01-05', time: '10:30 AM' },
  ];
        ...
        renderItem={({ item }) => (
          <View style={styles.historyCard}>
            <View style={styles.cardHeader}>
              <View style={styles.iconCircle}><MaterialCommunityIcons name="check" size={20} color="#10b981" /></View>
            ...
            <View style={styles.shopInfo}>
              ...
              <Text style={styles.shopNameText}>{item.shop} • {item.location}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#00b894', padding: 25, paddingTop: 50, borderBottomLeftRadius: 40, borderBottomRightRadius: 40 },
